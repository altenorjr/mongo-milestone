...
import Milestone, { ACTION_REQUIRED, TYPE_REQUIRED, PARAMETERS_EXPECTED } from '../../src/domain/Milestone';
...
describe('Milestone', () => {
    it("Can't be instantiated without a proper type parameter", () => {
        ...
        expect(fn1).to.throw(Error, PARAMETERS_EXPECTED);
    ...
    it("Can be instantiated with a type parameter, a valid root Action and no parameters (object)", () => {
        let milestone;
    ...
    it("Can be instantiated with a type parameter, a valid root Action and no parameters (parameters)", () => {
        let milestone;

        const action = new Action({ type: 'a' });

        const fn = () => { milestone = new Milestone('a', action) };
    ...
    it("Can be instantiated with a type parameter, a valid root Action and random parameters (obj)", () => {
        let milestone;
    ...
    it("Can be instantiated with a type parameter, a valid root Action and random parameters (parameters)", () => {
        let milestone;

        const action = new Action({ type: 'a' });

        const fn = () => { milestone = new Milestone('a', action, 'asd') };
